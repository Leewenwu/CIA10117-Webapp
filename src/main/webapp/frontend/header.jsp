                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                      <div class="full">
                          <div class="center-desk">
                              <div class="logo">
                                  <a href="./index.html">
                                      <img src="./images/JOYFUL RESORT - MarkMaker Logo.png" alt="">
                                  </a>
                              </div>
                          </div>
                      </div>
                      ...
                      <nav class="navigation navbar navbar-expand-md navbar-dark ">
                          ...
                          <div class="collapse navbar-collapse" id="navbarsExample04">
                              <ul class="navbar-nav mr-auto">
                                  ...
                                  <li class="nav-item">
                                      <a class="nav-link fw-bold" href="contact.html">關於我們</a>
                                  </li>
                                  <li class="nav-item">
                                      <a class="nav-link fw-bold" href="room.html">飯店設施</a>
                                  </li>
                                  <li class="nav-item">
                                      <a class="nav-link fw-bold" href="gallery.html">線上訂房</a>
                                  </li>
                                  <li class="nav-item">
                                  ...
                                  <li class="nav-item">
                                      <a class="nav-link fw-bold" href="log.html">會員專區</a>
                                  </li>
                              </ul>
                          </div>
                      </nav>
