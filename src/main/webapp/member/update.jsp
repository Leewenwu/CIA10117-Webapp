...
<body>
    ...
    <form action="${pageContext.request.contextPath}/member/member.do" method="post">
        ...
        <table>
            ...
            <tr>
                <th>密碼:</th>
                <td><input type="password" name="mPassword" value="${member.mPassword}"></td>
            </tr>
            <tr>
                <th>信箱:</th>
            ...
            <tr>
                <th>生日:</th>
                <td><input type="date" name="birthday" value="<fmt:formatDate value='${member.birthday}' pattern='yyyy-MM-dd'/>"></td>
            </tr>
            <tr>
                <td colspan="2">
<input type="submit" value="保存修改">
<input type="button" value="取消" onclick="location.href='${pageContext.request.contextPath}/member/member.do?action=getAll'">
                </td>
            </tr>
        </table>
    </form>
